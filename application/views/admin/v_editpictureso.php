                  ...
                  <ul class="nav nav-tabs">
                      <li class="active">
                        <a data-toggle="tab" href="#demo-lft-tab-2">
                            <i class="ti-pencil"></i>
                            <span class="menu-title">Edit Picture</span>
                        </a>
                      </li>
                        ...
                        <div class="">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="">
                                    <!--Horizontal Form-->
                                    <!--===================================================-->
                                   <form class="form-horizontal" enctype='multipart/form-data' method="post" action="<?php echo site_url('admin/updatepictureso')?>">
                                     <div class="form-group">
                                         <label class="col-md-2 control-label" for="demo-hor-inputemail"></label>
                                         <div class="col-sm-9">
                                           <input type="hidden" name="id" value="<?php echo $editpictureso->id_picture ?>">
                                           <div  class="image-upload" style="height: 200px; width: 100% ; ">
                                             <?php if ($editpictureso->picture == NULL) { ?>
                                             ...
                                             <?php } else { ?>
                                               <label  for="file-input" >
                                                 <img  class=""  src="<?php echo base_url('assets/admin/img/penyimpananfoto'.'/'.$editpictureso->picture); ?>"
                                             ...
                                             <input type='hidden' name='oldfile' value="<?php echo $editpictureso->picture ?>"  id='file-input' >
                                              <?php } ?>
