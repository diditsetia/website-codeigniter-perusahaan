                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="text-center">
                                                      <img class="img-responsive" src="<?php echo base_url('assets/admin/img/penyimpananfoto'.'/'.$datasejarah['foto_sejarah']); ?>" alt="Image">
                                                    </td>
                                                    <td >
                                                      <p class="text-main text-semibold" >
                                                        <?php echo $datasejarah['sejarah'] ?>
                                                      </p>
                                                    </td>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-sm-9">
                                            ...
                                            <input type='file' name='userfile' required id='file-input' >
            					                    ...
            					                    <div class="form-group">
            					                        <label class="col-md-2 control-label" for="demo-hor-inputemail">Sejarah</label>
            					                        <div class="col-sm-9">
                                                <div class="pane">
                                                   <div class="panel-body">
                                                       ...
                                                       <!--Summernote-->
                                                       <!--===================================================-->
                                                       <textarea id="demo-summernote"  name="sejarah">
