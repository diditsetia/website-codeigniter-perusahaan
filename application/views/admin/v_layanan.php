                					        ...
                					        <div class="panel">
                					            ...
                					            <div style="padding-bottom: 0px;" class="panel-body">
                					                <table class="table table-hover table-vcenter">
                                                        ...
                                                        <img class="img-responsive" src="<?php echo base_url('assets/admin/img/penyimpananfoto'.'/'.$datalayanan['picture']);  ?>" alt="Image">
                                                      </td>
                					                            <td>
                					                                <p class="text-main text-semibold">
                                                            <?php echo $datalayanan['layanan']?>
                                                          </p>
                					                            </td>
                					                            <td class="text-center">
                                                          <div class="btn-group">
                                                            <a href="<?php echo site_url('admin/hapuslayanan').'/'.$datalayanan['id_layanan']; ?>">
                                                              <button class="btn btn-default"><i class="ti-trash"></i></button>
                                                            </a>
                                                            <a href="<?php echo  site_url('admin/editlayanan').'/'.$datalayanan['id_layanan']; ?>">
                        ...
                        <div class="">
                                ...
                                <div class="col-sm-12">
              					        <div class="">
              					            <!--Horizontal Form-->
              					            <!--===================================================-->
              					            <form class="form-horizontal" enctype='multipart/form-data' method="post" action="<?php echo site_url('admin/aksilayanan')?>">
